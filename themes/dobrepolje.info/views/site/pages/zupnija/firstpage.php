	...
	<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/zupnija.css" />
		...
		<!-- Header Wrapper -->
			<div id="header-wrapper">
				...
				<!-- Header -->
					...
					'items'=>array(
						array('label'=>'DOBREPOLJE.INFO', 'url'=>array('/site/index')),
							)));
							?>
						<!-- Logo -->
							<h1 id="logo"><a href="<?php echo Yii::app()->getBaseUrl(true); ?>">ŽUPNIJA DOBREPOLJE - VIDEM</a></h1>
							<p><?php $this->widget('zii.widgets.CMenu',array(
					'items'=>array(
				//array('label'=>'Home', 'url'=>array('/site/index')),
				//array('label'=>'Vsebine', 'url'=>array('/vsebine/index')),
				//array('label'=>'Izvoz', 'url'=>array('/vsebine/izvoz')),
				//array('label'=>'ŽUPNIJA', 'url'=>array('/site/page', 'view'=>'zupnija.firstpage')),
