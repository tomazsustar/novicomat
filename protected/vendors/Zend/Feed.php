 ...
 * Feed utility class
 *
 * Base Zend_Feed class, containing constants and the EHttpClient instance
 * accessor.
 *
 * @category   Zend
 * @package    Zend_Feed
...
class Zend_Feed
{
     ...
     *
     * @param  EHttpClient $httpClient
     * @return void
     */
    public static function setHttpClient(EHttpClient $httpClient)
    {
    ...
    /**
     * Gets the HTTP client object. If none is set, a new EHttpClient will be used.
     *
     * @return EHttpClient
     */
    public static function getHttpClient()
    {
        if (!self::$_httpClient instanceof EHttpClient) {
            Yii::import('ext.httpclient.*');
            Yii::import('ext.httpclient.adapter.*');
            self::$_httpClient = new EHttpClient();
        }
